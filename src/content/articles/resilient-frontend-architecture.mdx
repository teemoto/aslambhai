...
<figure class="article-figure ecore-figure">
  ...
  />
  <figcaption>
    ECORE is a reinforcing cycle: expect failure, contain its effects, observe
    what happened, recover safely, and evolve the system.
  </figcaption>
</figure>
...
<figure class="article-figure">
  ...
  />
  <figcaption>
    Under normal conditions, both bridges work. Stress reveals the assumptions
    built into each design.
  </figcaption>
</figure>
...
<ComparisonTable
  ...
  rows={[
    [
      ...
      "A connection can disappear during a request, and an unknown response does not prove that a mutation failed",
      "Timeouts, bounded retries, idempotent operations, honest uncertain states",
    ],
    [
      "Latency is zero",
      "Latency varies by user, device, location, and moment",
      "Explicit loading states, prefetching, caching, and optimistic UI where it is safe",
    ],
    [
      "Bandwidth is infinite",
      "Large bundles and payloads increase startup time and impose unequal costs",
      "Code splitting, image and bundle budgets, pagination, response shaping",
    ],
    [
      "The network is secure",
      "Transport and remote data cross trust boundaries",
      "TLS, browser security controls, output safety, and runtime validation for untrusted data",
    ],
    [
      "Topology does not change",
      "A user can switch networks or reach a different service instance during a flow",
      "Resume from application state and treat connectivity indicators only as hints",
    ],
    [
      "There is one administrator",
      "Browsers, CDNs, ISPs, proxies, extensions, and blockers are controlled independently",
      "Avoid fragile assumptions about the path and degrade when optional resources are blocked",
    ],
    [
      "Transport cost is zero",
      "Transfer, parsing, allocation, and rendering all consume time and memory",
      "Reduce payloads, paginate or stream where useful, move heavy computation off the main thread when justified",
    ],
    [
      "The network is homogeneous",
      "Devices, browsers, networks, and user constraints vary widely",
      "Test representative lower-bound conditions based on the product’s audience",
    ],
  ]}
/>
...
<TranslationCards
  items={[
    {
      concept: "Replica and cache coherence",
      manifestation: "Client query cache plus revalidation",
      addresses: "Stale data and redundant requests",
    },
    {
      concept: "Explicit state ownership",
      manifestation:
        "Server-owned domain state, client-owned drafts, URL-owned navigation state",
      addresses: "Divergent copies and unclear authority",
    },
    {
      concept: "Eventual consistency",
      manifestation: "Showing cached data while a fresh version is fetched",
      addresses: "Blocking every read on the latest remote state",
    },
    {
      concept: "Read-your-writes experience",
      manifestation:
        "Optimistic updates followed by authoritative reconciliation",
      addresses: "A user’s action appearing to disappear",
    },
    {
      concept: "Idempotency",
      manifestation: "Stable operation identifiers supported by the server",
      addresses: "Duplicate mutations after retries or lost responses",
    },
    {
      concept: "Backpressure",
      manifestation:
        "Debouncing, concurrency limits, and discarding obsolete client work",
      addresses: "Request floods and main-thread overload",
    },
    {
      concept: "Bulkhead",
      manifestation:
        "Isolated widgets and carefully placed render error boundaries",
      addresses: "One failing area taking down the whole experience",
    },
    {
      concept: "Timeout and jittered retry",
      manifestation: "Bounded retry policy for classified transient failures",
      addresses: "Hung requests and synchronized retry storms",
    },
    {
      concept: "Request coalescing",
      manifestation: "Multiple consumers sharing one in-flight request",
      addresses: "Many components fetching the same resource",
    },
    {
      concept: "Ordering and causality",
      manifestation: "Ignoring or cancelling stale responses",
      addresses: "An older response overwriting newer state",
    },
    {
      concept: "Clock skew",
      manifestation:
        "Treating the client clock as untrusted for authoritative decisions",
      addresses: "Expiration and ordering bugs caused by incorrect local time",
    },
    {
      concept: "Expand-and-contract change",
      manifestation: "Backward-compatible API and asset deployments",
      addresses: "Old tabs communicating with newer services",
    },
  ]}
/>
...
<figure class="article-figure resilience-layers-figure">
  ...
  />
  <figcaption>
    Resilience comes from complementary protections across the stack, with
    observability supplying evidence from every layer.
  </figcaption>
</figure>
...
<ComparisonTable
  ...
  rows={[
    ...
    [
      "Observe",
      "What evidence will tell us what the user experienced and why?",
    ],
    ["Recover", "What safe path remains for the user and the system?"],
    [
      "Evolve",
      "What should change in the product, architecture, tests, or ownership model afterward?",
    ],
  ]}
/>
