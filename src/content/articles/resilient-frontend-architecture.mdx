...
<ComparisonTable rows={[
  { assumption: "The network is reliable", reality: "A connection can disappear during a request, and an unknown response does not prove that a mutation failed", response: "Timeouts, bounded retries, idempotent operations, honest uncertain states" },
  { assumption: "Latency is zero", reality: "Latency varies by user, device, location, and moment", response: "Explicit loading states, prefetching, caching, and optimistic UI where it is safe" },
  { assumption: "Bandwidth is infinite", reality: "Large bundles and payloads increase startup time and impose unequal costs", response: "Code splitting, image and bundle budgets, pagination, response shaping" },
  { assumption: "The network is secure", reality: "Transport and remote data cross trust boundaries", response: "TLS, browser security controls, output safety, and runtime validation for untrusted data" },
  { assumption: "Topology does not change", reality: "A user can switch networks or reach a different service instance during a flow", response: "Resume from application state and treat connectivity indicators only as hints" },
  { assumption: "There is one administrator", reality: "Browsers, CDNs, ISPs, proxies, extensions, and blockers are controlled independently", response: "Avoid fragile assumptions about the path and degrade when optional resources are blocked" },
  { assumption: "Transport cost is zero", reality: "Transfer, parsing, allocation, and rendering all consume time and memory", response: "Reduce payloads, paginate or stream where useful, move heavy computation off the main thread when justified" },
  { assumption: "The network is homogeneous", reality: "Devices, browsers, networks, and user constraints vary widely", response: "Test representative lower-bound conditions based on the product’s audience" },
]} />
